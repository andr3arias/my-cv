          ...
          <div class="col col--sm-8 col--sm-offset-2 col--md-12 col--md-offset-0 col--lg-10 col--lg-offset-1">
              <div class="row">
                  ...
                  <div class="col col--md-6">
                      <p class="home__contacts-content">Tienes alguna pregunta?<br></br>Siéntete libre de escribirme!</p>
                      <div class="home__contacts-info">
                          <p class="home__contacts-geo">Colombia</p>
                          <p class="home__contacts-mail"><a href="mailto:santiyabwana@gmail.com" target="_top">santiyabwana@gmail.com</a></p>
                          <p class="home__contacts-linkedin"><a href="https://www.linkedin.com/andr3arias">andr3arias</a></p>
                          <p class="home__contacts-twitter"><a href="https://www.twitter.com/andr3arias">@andr3arias</a></p>
                          <p class="home__contacts-github"><a href="https://www.github.com/andr3arias">andr3arias</a></p>
                      </div>
                  </div>
                  <div class="col col--md-6">
                    ...
                    <form class="form" id="contact-form">
                      ...
                      <div class="row">
                        ...
                        <label for="text" class="field__label">Mensaje</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col">
